...
raster::writeRaster(chm18, file = "DSM_2018_corrected_tin2.tif")

#### 2018 to 2019 #### 

# Make canopy height raster for each year

cat19at <- lidR::catalog(paste0(path2,"BCI19Tiles_alignedto18Trim/"))
...
raster::writeRaster(dsm19, file = "DSM_2019_corrected_tin2.tif")
...
raster::writeRaster(dsm20, file = "DSM_2020_corrected_tin2.tif",overwrite=T)

#### Make uncorrected DSMs ####

cat15_raw <- lidR::catalog('D:/BCI_Spatial/UAV_Data/TiledPointClouds/BCI15Tiles/')
chm15_raw <- lidR::grid_canopy(cat15_raw,
                               res = 1,
                               algorithm = lidR::p2r(subcircle=0.01,
                                                     na.fill = lidR::tin()))
raster::writeRaster(chm15_raw, file = "DSM_2015_raw_tin.tif")
rm(list = ls())
gc()

cat18_raw <- lidR::catalog('D:/BCI_Spatial/UAV_Data/TiledPointClouds/BCI18Tiles/')
chm18_raw <- lidR::grid_canopy(cat18_raw,
                               res = 1,
                               algorithm = lidR::p2r(subcircle=0.01,
                                                     na.fill = lidR::tin()))
raster::writeRaster(chm18_raw, file = "DSM_2018_raw_tin.tif")
rm(list = ls())
gc()


cat19_raw <- lidR::catalog('D:/BCI_Spatial/UAV_Data/TiledPointClouds/BCI19_Tiles/')
chm19_raw <- lidR::grid_canopy(cat19_raw,
                               res = 1,
                               algorithm = lidR::p2r(subcircle=0.01,
                                                     na.fill = lidR::tin()))
raster::writeRaster(chm19_raw, file = "DSM_2019_raw_tin.tif")
rm(list = ls())
gc()


cat20_raw <- lidR::catalog('D:/BCI_Spatial/UAV_Data/TiledPointClouds/BCI20Tiles/')
chm20_raw <- lidR::grid_canopy(cat20_raw,
                               res = 1,
                               algorithm = lidR::p2r(subcircle=0.01,
                                                     na.fill = lidR::tin()))
raster::writeRaster(chm20_raw, file = "DSM_2020_raw_tin.tif")
rm(list = ls())
gc()
