...
#### Write data to .tif rasters ####  
  raster::writeRaster(dsm09, file = "HeightRasterData/DSM_2009.tif")
  raster::writeRaster(dsm15, file = "HeightRasterData/DSM_2015_corrected.tif")
  raster::writeRaster(dsm18, file = "HeightRasterData/DSM_2018_corrected.tif")
  raster::writeRaster(dsm20, file = "HeightRasterData/DSM_2020_corrected.tif")
  ...
  # Make DSMs 
    ...
    dsm20_raw <- lidR::grid_canopy(cat20_raw,
                                   ...
                                   algorithm = lidR::p2r(subcircle=0.01,
                                                         na.fill = lidR::tin()))
  # Write raster files
    raster::writeRaster(dsm15_raw, file = "HeightRasterData/DSM_2015_raw.tif")
    raster::writeRaster(dsm18_raw, file = "HeightRasterData/DSM_2018_raw.tif")
    raster::writeRaster(dsm20_raw, file = "HeightRasterData/DSM_2020_raw.tif")
