...
# Read in digital surface model rasters:
  dsm09 <- raster::raster("HeightRasterData/DSM_2009.tif")
  dsm15 <- raster::raster("HeightRasterData/DSM_2015_corrected.tif")
  dsm18 <- raster::raster("HeightRasterData/DSM_2018_corrected.tif")
  dsm20 <- raster::raster("HeightRasterData/DSM_2020_corrected.tif")
...
# Read in BCI DEM
  dem <- raster::raster("HeightRasterData/LidarDEM_BCI.tif")
...
#### MAKE AND SAVE CANOPY HEIGHT CHANGE RASTERS ####  
  ...
  # Canopy height models for all years
    # chm15c <- raster::raster("CHM_2015_QAQC_tin.tif")
